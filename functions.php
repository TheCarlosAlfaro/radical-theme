...
if ( ! function_exists( 'radical_setup' ) ) :
	...
	function radical_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'radical' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'radical_custom_background_args', array(
...
function radical_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'radical_content_width', 640 );
}
...
function radical_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'radical' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'radical' ),
...
function radical_scripts() {
	...
	wp_enqueue_script( 'radical-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'radical-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
