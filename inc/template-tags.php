...
if ( ! function_exists( 'radical_posted_on' ) ) :
	...
	function radical_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'radical' ),
...
if ( ! function_exists( 'radical_entry_footer' ) ) :
	...
	function radical_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'radical' ) );
			if ( $tags_list ) {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'radical' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'radical' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'radical_post_thumbnail' ) ) :
	/**
